#!/usr/bin/env python3
"""
Enhanced HTML Report Generator for Symphony Trading System

This module provides improved HTML reporting with interactive charts and visualizations
for Symphony Trading System analysis results.
"""
...
class HTMLReportGenerator:
    """
    Enhanced HTML report generator with interactive visualizations.
    """
    ...
    def generate_report(self, results, include_plotly=True):
        """
        Generate an enhanced HTML report from analysis results.
        
        Args:
            results (dict): Analysis results from symphony_backtester
            include_plotly (bool): Whether to include interactive Plotly charts
        ...
        if include_plotly:
            # Only add this if we actually have plotly data
        ...
        html += f"""
        <footer>
            <p>Generated by Symphony Trading System on {timestamp}</p>
...
def main():
    """
    Main function to test the HTML report generator.
    """
    import argparse
    
    parser = argparse.ArgumentParser(description='Generate enhanced HTML reports from symphony analysis results')
    ...
    parser.add_argument('--no-plotly', action='store_true', 
                      help='Disable interactive Plotly charts')
    ...
    report_file = generator.generate_report(results, include_plotly=not args.no_plotly)
