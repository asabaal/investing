...
def generate_html_report(results, output_dir="symphony_analysis_results"):
    ...
    """
    logger.info("Generating HTML report from analysis results")
...
def main():
    ...
    logger.info(f"Symphony Backtester starting - Version 1.1.0")
    ...
    try:
        ...
        if args.html_report and results and "error" not in results:
